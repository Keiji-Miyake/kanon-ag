import { Rule, Passage } from '../models/score.js';
...
export class RuleEngine {
     ...
     * 次の Passage 名を決定します。
     */
    public determineNextPassage(output: string, currentPassage?: Passage): string | null {
     ...
     * 単一のルールをデータに対して評価します。
     */
    public evaluateRule(rule: Rule, data: any): boolean {
