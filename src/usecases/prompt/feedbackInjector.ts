...
export class FeedbackInjector {
     ...
     */
    public injectUserIntervention(currentInstruction: Instruction, message: string): Instruction {
        ...
        const amendedTasks = [...currentInstruction.tasks];
        amendedTasks.push(
            `USER INTERVENTION: The user has provided the following direct instruction/feedback that you must incorporate immediately:\n` +
            message
        );
